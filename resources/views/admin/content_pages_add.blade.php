<div class="wrapper container-fluid">
	{!! Form::open(['url' => route('pagesAdd'), 'class' => 'form-horizontal', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
		<div class="form-group">
			...
			<div class="col-xs-8">
				{!! Form::text('name', old('name'), ['class' => 'form-control', 'palceholder' => 'Введите название страницы']) !!}
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-8">
				{!! Form::text('alias', old('alias'), ['class' => 'form-control', 'palceholder' => 'Введите псевдоним страницы']) !!}
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-8">
				{!! Form::textarea('text', old('text'), ['id' => 'editor', 'class' => 'form-control', 'palceholder' => 'Введите текст страницы']) !!}
			</div>
		</div>
